...
- Massage acupressure to stimulate energy circulation`,
      ...
      {
        title: "Phục hồi chức năng sau chấn thương thể thao",
        titleEn: "Sports Injury Rehabilitation",
        slug: "phuc-hoi-chuc-nang-sau-chan-thuong-the-thao",
        description: "Các phương pháp phục hồi chức năng hiện đại giúp vận động viên trở lại thi đấu nhanh chóng.",
        descriptionEn: "Modern rehabilitation methods help athletes return to competition quickly.",
        shortDescription: "Phục hồi chức năng cho chấn thương thể thao.",
        shortDescriptionEn: "Rehabilitation for sports injuries.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: physicalTherapyCategory.id,
        metaTitle: "Phục hồi chức năng thể thao | HTC",
        metaTitleEn: "Sports Injury Rehab | HTC",
        metaDescription: "Phục hồi chức năng sau chấn thương thể thao tại HTC",
        metaDescriptionEn: "Sports injury rehabilitation at HTC",
        metaKeywords: "phục hồi chức năng, thể thao, chấn thương",
        metaKeywordsEn: "rehabilitation, sports, injury",
      },
      {
        title: "Tư thế đúng khi làm việc văn phòng",
        titleEn: "Proper Posture for Office Workers",
        slug: "tu-the-dung-khi-lam-viec-van-phong",
        description: "Hướng dẫn tư thế ngồi, đứng, làm việc đúng để phòng tránh đau lưng, đau cổ.",
        descriptionEn: "Guidance on proper sitting, standing, and working posture to prevent back and neck pain.",
        shortDescription: "Tư thế đúng giúp phòng tránh đau lưng.",
        shortDescriptionEn: "Proper posture helps prevent back pain.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: spinalHealthCategory.id,
        metaTitle: "Tư thế đúng khi làm việc | HTC",
        metaTitleEn: "Proper Office Posture | HTC",
        metaDescription: "Tư thế đúng khi làm việc văn phòng tại HTC",
        metaDescriptionEn: "Proper office posture at HTC",
        metaKeywords: "tư thế, văn phòng, đau lưng",
        metaKeywordsEn: "posture, office, back pain",
      },
      {
        title: "Chăm sóc sức khỏe người cao tuổi",
        titleEn: "Elderly Health Care",
        slug: "cham-soc-suc-khoe-nguoi-cao-tuoi",
        description: "Các phương pháp chăm sóc sức khỏe phù hợp cho người cao tuổi.",
        descriptionEn: "Appropriate health care methods for the elderly.",
        shortDescription: "Chăm sóc sức khỏe cho người cao tuổi.",
        shortDescriptionEn: "Health care for the elderly.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: traditionalMedicineCategory.id,
        metaTitle: "Chăm sóc sức khỏe người cao tuổi | HTC",
        metaTitleEn: "Elderly Health Care | HTC",
        metaDescription: "Chăm sóc sức khỏe người cao tuổi tại HTC",
        metaDescriptionEn: "Elderly health care at HTC",
        metaKeywords: "người cao tuổi, chăm sóc sức khỏe",
        metaKeywordsEn: "elderly, health care",
      },
      {
        ...
        description: "Các bài tập và phương pháp điều trị đau vai gáy hiệu quả.",
        descriptionEn: "Effective exercises and treatments for neck and shoulder pain.",
        shortDescription: "Điều trị đau vai gáy hiệu quả.",
        shortDescriptionEn: "Effective neck and shoulder pain treatment.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: spinalHealthCategory.id,
        metaTitle: "Điều trị đau vai gáy | HTC",
        metaTitleEn: "Neck and Shoulder Pain Treatment | HTC",
        metaDescription: "Điều trị đau vai gáy tại HTC",
        metaDescriptionEn: "Neck and shoulder pain treatment at HTC",
        metaKeywords: "đau vai gáy, điều trị, bài tập",
        metaKeywordsEn: "neck pain, shoulder pain, treatment, exercise",
      },
      {
        title: "Tác dụng của xông hơi thảo dược",
        titleEn: "Benefits of Herbal Steam Therapy",
        slug: "tac-dung-cua-xong-hoi-thao-duoc",
        description: "Xông hơi thảo dược giúp thư giãn, giải độc và tăng cường sức khỏe.",
        descriptionEn: "Herbal steam therapy helps relax, detoxify, and boost health.",
        shortDescription: "Xông hơi thảo dược tăng cường sức khỏe.",
        shortDescriptionEn: "Herbal steam therapy boosts health.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: traditionalMedicineCategory.id,
        metaTitle: "Xông hơi thảo dược | HTC",
        metaTitleEn: "Herbal Steam Therapy | HTC",
        metaDescription: "Tác dụng của xông hơi thảo dược tại HTC",
        metaDescriptionEn: "Benefits of herbal steam therapy at HTC",
        metaKeywords: "xông hơi, thảo dược, thư giãn",
        metaKeywordsEn: "steam, herbal, relax",
      },
      {
        title: "Phục hồi chức năng sau phẫu thuật",
        titleEn: "Post-Surgery Rehabilitation",
        slug: "phuc-hoi-chuc-nang-sau-phau-thuat",
        description: "Các phương pháp phục hồi chức năng sau phẫu thuật giúp bệnh nhân hồi phục nhanh hơn.",
        descriptionEn: "Rehabilitation methods after surgery help patients recover faster.",
        shortDescription: "Phục hồi chức năng sau phẫu thuật.",
        shortDescriptionEn: "Rehabilitation after surgery.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: physicalTherapyCategory.id,
        metaTitle: "Phục hồi chức năng sau phẫu thuật | HTC",
        metaTitleEn: "Post-Surgery Rehab | HTC",
        metaDescription: "Phục hồi chức năng sau phẫu thuật tại HTC",
        metaDescriptionEn: "Post-surgery rehabilitation at HTC",
        metaKeywords: "phục hồi chức năng, phẫu thuật",
        metaKeywordsEn: "rehabilitation, surgery",
      },
      {
        title: "Tập luyện yoga cho sức khỏe cột sống",
        titleEn: "Yoga for Spinal Health",
        slug: "tap-luyen-yoga-cho-suc-khoe-cot-song",
        description: "Yoga giúp tăng cường sức khỏe cột sống và phòng ngừa đau lưng.",
        descriptionEn: "Yoga helps improve spinal health and prevent back pain.",
        shortDescription: "Yoga cho sức khỏe cột sống.",
        shortDescriptionEn: "Yoga for spinal health.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: spinalHealthCategory.id,
        metaTitle: "Yoga cho sức khỏe cột sống | HTC",
        metaTitleEn: "Yoga for Spinal Health | HTC",
        metaDescription: "Tập luyện yoga cho sức khỏe cột sống tại HTC",
        metaDescriptionEn: "Yoga for spinal health at HTC",
        metaKeywords: "yoga, cột sống, đau lưng",
        metaKeywordsEn: "yoga, spine, back pain",
      },
      {
        title: "Chăm sóc sức khỏe mùa lạnh",
        titleEn: "Health Care in Cold Season",
        slug: "cham-soc-suc-khoe-mua-lanh",
        description: "Các lưu ý chăm sóc sức khỏe khi thời tiết chuyển lạnh.",
        descriptionEn: "Health care tips for the cold season.",
        shortDescription: "Chăm sóc sức khỏe mùa lạnh.",
        shortDescriptionEn: "Health care in cold season.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: traditionalMedicineCategory.id,
        metaTitle: "Chăm sóc sức khỏe mùa lạnh | HTC",
        metaTitleEn: "Cold Season Health Care | HTC",
        metaDescription: "Chăm sóc sức khỏe mùa lạnh tại HTC",
        metaDescriptionEn: "Health care in cold season at HTC",
        metaKeywords: "mùa lạnh, chăm sóc sức khỏe",
        metaKeywordsEn: "cold season, health care",
      },
      {
        title: "Phòng ngừa loãng xương ở người lớn tuổi",
        titleEn: "Osteoporosis Prevention in the Elderly",
        slug: "phong-ngua-loang-xuong-o-nguoi-lon-tuoi",
        description: "Các biện pháp phòng ngừa loãng xương hiệu quả cho người lớn tuổi.",
        descriptionEn: "Effective osteoporosis prevention for the elderly.",
        shortDescription: "Phòng ngừa loãng xương ở người lớn tuổi.",
        shortDescriptionEn: "Osteoporosis prevention in the elderly.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: physicalTherapyCategory.id,
        metaTitle: "Phòng ngừa loãng xương | HTC",
        metaTitleEn: "Osteoporosis Prevention | HTC",
        metaDescription: "Phòng ngừa loãng xương ở người lớn tuổi tại HTC",
        metaDescriptionEn: "Osteoporosis prevention in the elderly at HTC",
        metaKeywords: "loãng xương, người lớn tuổi, phòng ngừa",
        metaKeywordsEn: "osteoporosis, elderly, prevention",
      },
      {
        title: "Bấm huyệt giảm đau đầu",
        titleEn: "Acupressure for Headache Relief",
        slug: "bam-huyet-giam-dau-dau",
        description: "Bấm huyệt là phương pháp tự nhiên giúp giảm đau đầu hiệu quả.",
        descriptionEn: "Acupressure is a natural method for effective headache relief.",
        shortDescription: "Bấm huyệt giảm đau đầu hiệu quả.",
        shortDescriptionEn: "Acupressure for effective headache relief.",
        status: "PUBLISHED",
        showOnHomepage: false,
        pin: false,
        categoryId: traditionalMedicineCategory.id,
        metaTitle: "Bấm huyệt giảm đau đầu | HTC",
        metaTitleEn: "Acupressure for Headache | HTC",
        metaDescription: "Bấm huyệt giảm đau đầu tại HTC",
        metaDescriptionEn: "Acupressure for headache at HTC",
        metaKeywords: "bấm huyệt, đau đầu, giảm đau",
        metaKeywordsEn: "acupressure, headache, pain relief",
      },
    ];
