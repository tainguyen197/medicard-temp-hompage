    ...
    <>
      ...
      <section className="container mx-auto px-4 py-4 md:py-6">
        <div className="flex items-center text-lg">
          ...
          <span className="text-black">Phục hồi chức năng</span>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 pt-4 pb-10 md:pt-6 md:pb-16">
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-black">
          Phương pháp điều trị toàn diện cho chất lượng cuộc sống
        </h2>
      </section>
      ...
      <section className="container mx-auto px-4 pb-16 md:pb-24">
        <div className="bg-gray-100 p-8 rounded-lg text-center">
          ...
          <p className="text-base md:text-lg text-gray-700">
            Chúng tôi đang cập nhật thông tin chi tiết về dịch vụ Phục hồi chức
            năng. Vui lòng quay lại sau.
          </p>
        </div>
      </section>
