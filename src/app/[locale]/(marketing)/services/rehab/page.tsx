...
export default async function RehabPage() {
  ...
  const t = messages.services.individual.physicalTherapy;
      ...
      <section className="container mx-auto px-4 pb-16 md:pb-24 max-w-7xl">
        <div className="space-y-12 md:space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-8 md:gap-12">
            <div>
              ...
              <p className="text-md md:text-[16px] text-black leading-relaxed mt-4">
                <strong>{t.laser.effects.title}</strong>
              </p>
              <ul className="list-disc pl-5 mt-2 space-y-2 text-md md:text-[16px] text-black">
                <li>
                  <strong>{t.laser.effects.painRelief.split(":")[0]}:</strong>{" "}
                  {t.laser.effects.painRelief.split(":")[1]}
                </li>
                <div className="order-1 md:order-2">
                  <div className="relative w-full h-64 md:h-full min-h-[300px] max-w-2xl mx-auto">
                    <Image
                ...
                <li>
                  <strong>{t.laser.effects.cellRecovery.split(":")[0]}:</strong>{" "}
                  {t.laser.effects.cellRecovery.split(":")[1]}
                </li>
                <li>
                  <strong>{t.laser.effects.circulation.split(":")[0]}:</strong>{" "}
                  {t.laser.effects.circulation.split(":")[1]}
                </li>
              </ul>
              <p className="text-md md:text-[16px] text-black leading-relaxed mt-4">
                {t.laser.wavelengths}
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-8 md:gap-12">
            <div className="order-2 md:order-1">
              <h3 className="text-md md:text-[18px] font-semibold mb-4">
                {t.radioFrequency.title}
              </h3>
              <p className="text-md md:text-[16px] text-black leading-relaxed">
                {t.radioFrequency.description1}
              </p>
              <p className="text-md md:text-[16px] text-black leading-relaxed mt-2">
                {t.radioFrequency.description2}
              </p>
              <div className="order-1 md:order-2">
                <div className="relative w-full h-64 md:h-full min-h-[300px] max-w-2xl mx-auto">
                  <Image
              ...
              <p className="text-md md:text-[16px] text-black leading-relaxed mt-4">
                <strong>{t.radioFrequency.effects.title}</strong>
              </p>
              <div className="order-1 md:order-2">
                <div className="relative w-full h-64 md:h-full min-h-[300px] max-w-2xl mx-auto">
                  <Image
              ...
              <ul className="list-disc pl-5 mt-2 space-y-2 text-md md:text-[16px] text-black">
                <li>
                  <strong>
                    {t.radioFrequency.effects.painElimination.split(":")[0]}:
                  </strong>{" "}
                  {t.radioFrequency.effects.painElimination.split(":")[1]}
                </li>
                <li>
                  <strong>
                    {t.radioFrequency.effects.mobility.split(":")[0]}:
                  </strong>{" "}
                  {t.radioFrequency.effects.mobility.split(":")[1]}
                </li>
                <li>
                  <strong>
                    {t.radioFrequency.effects.healing.split(":")[0]}:
                  </strong>{" "}
                  {t.radioFrequency.effects.healing.split(":")[1]}
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-8 md:gap-12">
            <div>
              ...
              <p className="text-md md:text-[16px] text-black leading-relaxed">
                {t.shockwave.description}
              </p>
              <div className="order-1 md:order-2">
                <div className="relative w-full h-64 md:h-full min-h-[300px] max-w-2xl mx-auto">
                  <Image
                    src="/images/VLTL 7.jpg"
                    alt={t.shockwave.title}
                    className="object-contain rounded-lg"
                    fill
                  />
                </div>
              ...
              <p className="text-md md:text-[16px] text-black leading-relaxed mt-4">
                <strong>{t.shockwave.effects.title}</strong>
              </p>
              <ul className="list-disc pl-5 mt-2 space-y-2 text-md md:text-[16px] text-black">
                <li>
                  <strong>{t.shockwave.effects.recovery.split(":")[0]}:</strong>{" "}
                  {t.shockwave.effects.recovery.split(":")[1]}
                </li>
                <li>
                  <strong>
                    {t.shockwave.effects.painRelief.split(":")[0]}:
                  </strong>{" "}
                  {t.shockwave.effects.painRelief.split(":")[1]}
                </li>
                <li>
                  <strong>
                    {t.shockwave.effects.circulation.split(":")[0]}:
                  </strong>{" "}
                  {t.shockwave.effects.circulation.split(":")[1]}
                </li>
                <li>
                  <strong>
                    {t.shockwave.effects.calciumDeposits.split(":")[0]}:
                  </strong>{" "}
                  {t.shockwave.effects.calciumDeposits.split(":")[1]}
                </li>
              </ul>
            </div>
          </div>
