  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
        <div>
          <h2 className="font-medium text-blue-800">News Management</h2>
          <p className="text-sm text-blue-700 mt-1">
            Manage your news articles and blog posts. News are displayed on the
            news page of your website.
          </p>
        </div>
      </div>

      <Suspense fallback={<NewsSkeletonContent />}>
